...
# اگه نماد لحظه‌ی عبور از آستانه در صف خرید باشه، این عبور نادیده گرفته
# می‌شه (و در Gist هم علامت "ارسال‌شده" نمی‌خوره) تا وقتی از صف خرید خارج
# بشه و هنوز بالای آستانه بود، آلارم واقعی همون‌موقع بره. اگه نماد قبلاً
# (وقتی صف خرید نبوده) از آستانه عبور کرده و آلارم رفته، ورود بعدی‌اش به
# صف خرید تاثیری نداره چون dedup روزانه‌ی Gist دیگه اجازه‌ی ارسال دوباره
# رو نمی‌ده.
...
# ماروبوزو = کندلی تقریباً بدون سایه (قیمت اول ≈ کف روز، قیمت آخر ≈ سقف روز)
