...
WATCHLIST_SYMBOLS = {
    'فولاد': 3.0,      # اگه بیشتر از 3% رشد کرد
    'خودرو': 2.5,      # اگه بیشتر از 2.5% رشد کرد
    'شپنا': 4.0,       # اگه بیشتر از 4% رشد کرد
    'فملی': 3.5,       # اگه بیشتر از 3.5% رشد کرد
    # نمادهای دیگه رو اینجا اضافه کن
}

# فیلتر 4: صف خرید سنگین در سقف قیمت
CEILING_FILTER_CONFIG = {
    'price_range_percent': 5.0,         # دامنه نوسان (معمولاً 5% در بورس ایران)
...
POL_HAGIGI_FILTER_CONFIG = {
    ...
    'min_sarane_kharid': 5.0,           # حداقل 50 میلیون تومان سرانه خرید (واحد: میلیون)
...
SWING_TRADE_CONFIG = {
    'min_allowed_price': -5.0,          # حداقل آستانه مجاز (مثلاً -5% دامنه منفی)
    'max_last_change_percent': -2.0,    # درصد آخرین کمتر از -2%
    'min_godrat_kharid': 2.0,           # حداقل قدرت خرید
    'min_sarane_kharid': 5.0,           # حداقل 50 میلیون سرانه خرید (واحد: میلیون)
}
